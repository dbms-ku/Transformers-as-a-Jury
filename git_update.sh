...
# Default: /home/iot/workspace/Transformers-as-a-Jury-ext


echo "🕒 Run started at $(date)" >> /home/iot/workspace/Transformers-as-a-Jury-extgit_update.log

# Set target directory (use default if not provided)
TARGET_DIR=${1:-/home/iot/workspace/Transformers-as-a-Jury-ext}
...
if ! git diff-index --quiet HEAD --; then
  ...
  git commit -m "rpi5-G2A: text generation in progress"
